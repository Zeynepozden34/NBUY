...
function updateStatus(selectedTask){
    // console.log(selectedTask.parentElement.lastElementChild); bu uzun yol nütün divi seçip en sondaki selecti getirir bize
    //console.log(selectedTask.nextElementSibling); // kısa yol
