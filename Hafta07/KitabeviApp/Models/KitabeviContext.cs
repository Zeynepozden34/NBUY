    ...
    public class KitabeviContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Kitap>()
                .HasData(
                    new Kitap() { AnaSayfa=true, Id = 1, Ad = "İnsanlar", BasimYili = 2021, SayfaSayisi = 330, KategoriId = 2, YazarId = 1, Ozet="  Lorem ipsum, dolor sit amet consectetur adipisicing elit. Atque temporibus labore ipsam magni dicta laborum similique quam cupiditate eius. Debitis nemo eius ducimus officiis corrupti dolorum expedita neque distinctio tempora!" },
                    ...
                    new Kitap() { AnaSayfa=true,Id = 5, Ad = "Serenad", BasimYili = 2020, SayfaSayisi = 300, KategoriId = 2, YazarId = 9, Ozet="  Lorem ipsum, dolor sit amet consectetur adipisicing elit. Atque temporibus labore ipsam magni dicta laborum similique quam cupiditate eius. Debitis nemo eius ducimus officiis corrupti dolorum expedita neque distinctio tempora!" },
                    
                    new Kitap() { AnaSayfa=true,Id = 6, Ad = "19", BasimYili = 2016, SayfaSayisi = 380, KategoriId = 2, YazarId = 6, Ozet="  Lorem ipsum, dolor sit amet consectetur adipisicing elit. Atque temporibus labore ipsam magni dicta laborum similique quam cupiditate eius. Debitis nemo eius ducimus officiis corrupti dolorum expedita neque distinctio tempora!" },
                    
                    new Kitap() { AnaSayfa=true,Id = 7, Ad = "C# Programlama Dili", BasimYili = 2011, SayfaSayisi = 730, KategoriId = 3, YazarId = 7, Ozet="  Lorem ipsum, dolor sit amet consectetur adipisicing elit. Atque temporibus labore ipsam magni dicta laborum similique quam cupiditate eius. Debitis nemo eius ducimus officiis corrupti dolorum expedita neque distinctio tempora!" },
                   
                    new Kitap() { AnaSayfa=true,Id = 8, Ad = "React Uygulama Geliştirme", BasimYili = 2021, SayfaSayisi = 530, KategoriId = 3, YazarId = 3, Ozet="  Lorem ipsum, dolor sit amet consectetur adipisicing elit. Atque temporibus labore ipsam magni dicta laborum similique quam cupiditate eius. Debitis nemo eius ducimus officiis corrupti dolorum expedita neque distinctio tempora!" },
                   
                    new Kitap() { AnaSayfa=true,Id = 9, Ad = "İnsan Ömrünü Neyle Geçirmeli?", BasimYili = 2021, SayfaSayisi = 330, KategoriId = 2, YazarId = 8, Ozet="  Lorem ipsum, dolor sit amet consectetur adipisicing elit. Atque temporibus labore ipsam magni dicta laborum similique quam cupiditate eius. Debitis nemo eius ducimus officiis corrupti dolorum expedita neque distinctio tempora!" }
                );
        }
    }
}