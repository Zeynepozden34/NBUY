...
namespace Proje06_MVC_KitapEviDb.Migrations
{
    public partial class KitapeviAppDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Kitaplar_Categories_KategoriId",
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Ad", "Desc" },
                values: new object[] { 1, "Çocuk", "Çocuk Kitapları" });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Ad", "Desc" },
                values: new object[] { 2, "Edebiyat", "Roman, Hikaye, Şiir Kitapları" });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Ad", "Desc" },
                values: new object[] { 3, "Bilgisayar", "Bilgisayar Kitapları" });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Ad", "Desc" },
                values: new object[] { 4, "Akademik", "Akademik Kitaplar" });
