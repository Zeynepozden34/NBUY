...
{
    public class KitapEviDb:DbContext
    {
        ...
        {
            optionsBuilder.UseSqlite("Data Source=Kitapevi.Db");
        }
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Kategori>()
                .HasData(
                    new Kategori() { Id = 1, Ad = "Çocuk", Desc = "Çocuk Kitapları" },
                    new Kategori() { Id = 2, Ad = "Edebiyat", Desc = "Roman, Hikaye, Şiir Kitapları" },
                    new Kategori() { Id = 3, Ad = "Bilgisayar",Desc = "Bilgisayar Kitapları" },
                    new Kategori() { Id = 4, Ad = "Akademik", Desc = "Akademik Kitaplar" }
                );
