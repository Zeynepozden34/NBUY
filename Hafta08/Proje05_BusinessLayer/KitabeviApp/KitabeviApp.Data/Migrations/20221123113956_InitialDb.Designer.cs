...
namespace KitabeviApp.Data.Migrations
{
    [DbContext(typeof(KitabeviContext))]
    [Migration("20221123113956_InitialDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KitabeviApp.Entity.Kategori", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("KitabeviApp.Entity.Kitap", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("KitabeviApp.Entity.Yazar", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("KitabeviApp.Entity.Kitap", b =>
                {
                    b.HasOne("KitabeviApp.Entity.Kategori", "Kategori")
                        .WithMany()
                        .HasForeignKey("KategoriId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("KitabeviApp.Entity.Yazar", "Yazar")
                        .WithMany()
