...
namespace BlogApp.Data.Concrete.EntityFramework.Mappings
{
    public class UserMap : IEntityTypeConfiguration<User>
    {
        ...
        {
            builder.HasKey(u => u.Id);//PrimaryKey
            builder.Property(u => u.Id).ValueGeneratedOnAdd();

            builder.Property(u=>u.Email).IsRequired().HasMaxLength(50);
            builder.Property(u => u.Email).IsUnicode(); // Benzersiz değer özelliği

            builder.Property(u => u.UserName).IsRequired().HasMaxLength(20);
            builder.Property(u => u.UserName).IsUnicode(); // Benzersiz değer özelliği
            ...
            builder.HasData(
                new User
                {
                    ...
                    PasswordHash=Encoding.ASCII.GetBytes("200820e3227815ed1756a6b531e7e0d2") //qwe123 şifremizin hashlenmiş halidir.
                },
                new User
                {
                    Id = 2,
                    ...
                    PasswordHash = Encoding.ASCII.GetBytes("46f94c8de14fb36680850768ff1b7f2a") //123qwe şifremizin hashlenmiş halidir.
                }
                );
...
// MD5 Hash Generator,  passwordhash için şifreyi şifreleme googleden bak.