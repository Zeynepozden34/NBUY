$(document).ready(function () {
    ...
    $(function () {
        ...
        placeHolderDiv.on('click', '#btnSave', function (event) {
            ...
            const actionUrl = form.attr('action'); //formdaki action attribure çalışacak categoryaddpartialda asp-action: action olan yani.
            const dataToSend = form.serialize(); // formu json formatında seriliaze edip dataToSende gönderecek.
    ...
    $(function () {
        ...
        const placeHolderDiv = $('#modalPlaceHolder');
        //categoryUpdtePartiel vİEW GEETİRME
        ...
        // categoryUpdtePartiel vİEW GEETİRME BİTTİ
        ...
        placeHolderDiv.on('click', '#btnUpdate', function () {
            ...
            placeHolderDiv.find('.modal-body').replaceWith(newFormBody);
                    ...
                    if (isValid) {
                        ...
                        placeHolderDiv.find('.modal').modal('hide'); //formu kapatan yer
