...
namespace ShoppingApp.Data.Config
{
    public class ProductCategoryConfig : IEntityTypeConfiguration<ProductCategory>
    {
        ...
        {
            builder.HasKey(pc => new { pc.ProductId, pc.CategoryId }); // ProductId ve CategoryIdden oluşan bir satırın bir kez daha tekrar etmemesi için Bİr composite primarykey tanımlaması yaptık.
