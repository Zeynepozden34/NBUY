...
namespace ShoppingApp.Web.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            List<OrderListDto> orderListDtos= new List<OrderListDto>(); //OrderListDto adminde olmayan modelimizi kullandk.
            OrderListDto orderListDto;
            foreach (var order in orders) // her bir order için bie order listesi yarattık.
            {
