...
namespace OzelDers.Data.Migrations
{
    ...
    public partial class InitialDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Teachers",
                columns: new[] { "Id", "Age", "BranchId", "CertifiedTrainer", "Description", "Email", "FirstName", "Gender", "HourlyPrice", "ImageUrl", "IsDeleted", "IsFacetoFace", "LastName", "Location", "UniverstyGraduatedFrom" },
                values: new object[,]
                {
                    { 1, 27, 5, true, "Engish lessons are given.", "jackbrand@ozelders.com", "Jack", "erkek", 800, "20.png", false, false, "Brand", "Toronto/Canada", "Cambridge University" },
                    { 2, 27, 2, true, "Fizik dersi verilir.", "sevgiozer@ozelders.com", "Sevgi", "kadın", 400, "21.png", false, true, "Özer", "Avcılar/İstanbul", "İstanbul Üniversitesi" },
                    { 3, 35, 1, true, "Matematik dersi verilir.", "denizkuru@ozelders.com", "Deniz", "kadın", 600, "22.png", false, true, "Kuru", "Avcılar/İstanbul", "Haccettepe Üniversitesi" },
                    { 4, 30, 3, true, "Kimya dersi verilir.", "selimgoren@ozelders.com", "Selim", "erkek", 650, "23.png", false, true, "Gören", "Çankaya/Ankara", "Marmara Üniversitesi" },
                    { 5, 40, 9, false, "C# dersi verilir.", "kemaleren@ozelders.com", "Kemal", "erkek", 400, "24.png", false, true, "Eren", "Bornova/İzmir", "Fırat Üniversitesi" },
                    { 6, 25, 6, true, "Edebiyat dersi verilir.", "melissusan@ozelders.com", "Melis", "kadın", 600, "25.png", false, true, "Susan", "Sefaköy/İstanbul", "İstanbul Üniversitesi" },
                    { 7, 34, 8, true, "Almanca dersi verilir.", "defnebilen@ozelders.com", "Defne", "kadın", 500, "26.png", false, false, "Bilen", "Buca/İzmir", "Dokuz Eylül Üniversitesi" }
                });
